...
First, you'll get an error if the response isn't a JSON. This error doesn't doesn't come from the API itself. It happened because we made a mistake. We tried to parse data that isn't JSON.
...
1. I build zlFetch and I'm biased 😝
