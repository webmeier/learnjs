...
You learned how to filter the data according to multiple categories in this lesson. The code we have now worked, but isn't clean and pretty. You'll learn how to clean up and future-proof the code in later lessons.
