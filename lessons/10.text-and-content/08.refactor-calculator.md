...
As above, want to move everything that changes `display.textContent` into `createResultString`. Here, we only need to move the `display.textContent = '0'` line into `createResultString`. 
