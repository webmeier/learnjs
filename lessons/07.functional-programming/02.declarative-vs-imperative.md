...
Or, it could be a slightly more declarative program, like a `filter` function. Note how you'll always have at least one line of imperative code in the program. You can't run away from it entirely.
...
Plus, don't get confused and label Functional and Object Oriented Programming as Declarative or Imperative paradigms from this point onwards.