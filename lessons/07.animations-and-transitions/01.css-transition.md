...
`ease` is a weird. Its a faster version of `ease-out` for some weird reason. I don't really know how to comment on it. See the difference between `ease` and other timing functions for yourself in the demo (below).
