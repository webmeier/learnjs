...
(Note: transitioning `height` may cause jank. In this case, there's no other way round. Is having some jank better than having no animations at all? You decide.)
