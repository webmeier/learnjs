...
If you click on the gear icon, `event.target` would be the gear icon. If you click on the "settings" word, the `event.target` would be the word. That's not good.
