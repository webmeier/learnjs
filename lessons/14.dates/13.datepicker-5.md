...
<figure><img src="../../images/components/datepicker/prev-next-month/datetime.gif" alt="Logging the datetime into the console. Shows 2019-02."></figure>

We need to create a `Date` from this `datetime` attribute. A simple way is to create a `Date` from the `datetime` attribute. 
