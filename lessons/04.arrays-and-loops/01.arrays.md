...
You can add items to the array while creating it. To do so, you in list items in the array, and separate each item with a comma.
...
Previous lesson: [How to use a linter](../03.building-simple-components/08.linter.md)
Next lesson: [For loops](02.for-loops.md)