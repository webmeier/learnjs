...
<figure>
  <img src="../../images/03/events/button.png" alt="A button">
...
<figure>
  <img src="../../images/03/events/click.gif" alt="Logging a click">
...
<figure>
  <img src="../../images/03/events/exist-chrome-1.png" alt="getEventListeners tells you the number an listeners attached to an Element.">
...
<figure>
  <img src="../../images/03/events/exist-chrome-2-elements.png" alt="Click on the Element to make the inspection process easier">
...
<figure>
  <img src="../../images/03/events/exist-chrome-2-dollar0.png" alt="You can access the selected Element with $0">
...
<figure>
  <img src="../../images/03/events/exist-chrome-2-check.png" alt="Checking the existing of event listeners with $0">
...
<figure>
  <img src="../../images/03/events/exist-firefox-ev.png" alt="Firefox has shows you an ev icon for any element that has event listeners attached to it">
...
<figure>
  <img src="../../images/03/events/exist-firefox-ev-click.png" alt="Clicking on the ev shows you details about events attached to the Element">
...
<figure>
  <img src="../../images/03/events/exist-firefox-ev-code.png" alt="Clicking on event listener details shows you the code used">
...
<figure>
  <img src="../../images/03/events/change.gif" alt="Changing the DOM through events">
...
<figure>
  <img src="../../images/03/events/revert.gif" alt="Sets body background-color and button background-color when the button is clicked. Revert these styles when the button is clicked again.">
...
<figure>
  <img src="../../images/03/events/change.gif" alt="You can use classes to separate functionality and presentation">
...
<figure>
  <img src="../../images/03/events/revert.gif" alt="Reverting styles with classes">
