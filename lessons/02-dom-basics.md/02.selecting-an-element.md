...
// => <div class="class-of-assassins">Class</div>
...
Practice selecting Elements with `document.querySelector` and `Element.querySelector`. Try a using ids, classes, tags and attribute selectors as you select from the following HTML.
