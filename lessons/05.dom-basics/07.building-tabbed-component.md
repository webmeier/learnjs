...
<figure>
  <img src="../../images/components/tabs/basic-explain.png" alt="Tabbed components contains tabs and tabbed content">
...
This is normal. When you try to click on an `<a>` with `href` that begins with `#`, browsers will search for an element with an id that matches the `href`. When it finds it, it navigates to it. You'll learn how to prevent this awkward jump in the events deep dive module.
