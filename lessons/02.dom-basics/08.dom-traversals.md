...
<figure>
  <img src="../../images/02/traversal/queryselector.png" alt="Getting the right title with querySelector">
...
The `children` property allows you to select all direct descendants of any HTML element. It returns a live **HTML Collection** that updates automatically children elements change.
...
<figure>
  <img src="../../images/02/traversal/children.png" alt="Selecting all list items with the children property">
...
<figure>
  <img src="../../images/02/traversal/specific-child.png" alt="Select a specific child with [index]">
...
1. nextSiblingElement
2. previousSiblingElement

### nextSiblingElement

You can select the next element with `nextSiblingElement`.

```js
const nextElem = Node.nextSiblingElement
```
...
```js
const firstListItem = document.querySelector('li')
const secondListItem = firstListItem.nextSiblingElement
...
Likewise, you can select the previous element with `previousSiblingElement`.
...
const firstListItem = firstListItem.previousSiblingElement
