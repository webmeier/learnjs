...
To assign values to parametrs, you pass in arguments. Arguments are comma-separated values you use in the function call.
...
They are important. You'll learn why when you use arrow functions in the next lesson.
