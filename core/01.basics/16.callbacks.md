...
Callbacks are common in JavaScript. You'll encounter callbacks when you use [events]() (not done yet) and [advanced array methods]() (not done yet).
...
<figure>
  <img src="../../images/core/01/callbacks/timeout.gif" alt="Hello world appears one second after refreshing the page">
...
<figure>
  <img src="../../images/core/01/callbacks/timeout-2.gif" alt="Two different functions are executed after the timeout">
...
<figure>
  <img src="../../images/core/01/callbacks/timeout-3.gif" alt="JavaScript executes other code while waiting for setTimeout">
...
<figure>
  <img src="../../images/core/01/callbacks/todo.png" alt="Commands appear synchronously on JavaScript's todo list">
...
<figure>
  <img src="../../images/core/01/callbacks/todo2.png" alt="JavaScript's todo list">
...
<figure>
  <img src="../../images/core/01/callbacks/waiting.png" alt="JavaScript waits for pizza to arrive">
...
<figure>
  <img src="../../images/core/01/callbacks/mental-note.png" alt="JavaScript knows it needs to execute layTheTable by adding the command to its mental note">
...
<figure>
  <img src="../../images/core/01/callbacks/lay-table.png" alt="JavaScript lays the table when everything else is completed">
...
<figure>
  <img src="../../images/core/01/callbacks/event-loop.png" alt="JavaScript's event loop">
