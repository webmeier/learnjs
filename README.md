...
10. Text and Content
    ...
    5. [🛠️ Creating dots automatically for the carousel](lessons/10.text-and-content/05.improving-carousel.md)—new!
...
11. Forms
    ...
    4. [Sanitize your output](lessons/11.forms/04.sanitize-output.md)—new!
    5. [Generating unique IDs](lessons/11.forms/05.generate-unique-ids.md)—new!
